...
function addOrUpdateAthlete() {
    ...
    const maleKumite = document.querySelector('input[name="18-22_maleKumite"]:checked');
    const femaleKumite = document.querySelector('input[name="18-22_femaleKumite"]:checked');
    const maleKumiteTeam = document.querySelector('input[name="18-22_maleKumiteTeam"]:checked');
    const femaleKumiteTeam = document.querySelector('input[name="18-22_femaleKumiteTeam"]:checked');
    ...
    if (validateAge(yearOfBirth) && name && yearOfBirth && club && selectedCategories.length > 0) {
        ...
        alert('Vui lòng nhập đầy đủ thông tin, chọn ít nhất một môn thi đấu và đảm bảo tuổi hợp lệ (18-22).');
    }
}
...
function displayCategories(categories) {
    let categoryCells = '';
    const allCategories = [
        '18-22_maleKata', '18-22_femaleKata', '18-22_ddnamKata', '18-22_ddnuKata',
        '18-22_maleKumite50', '18-22_maleKumite55', '18-22_maleKumite60', '18-22_maleKumite65', '18-22_maleKumite70', '18-22_maleKumite75', '18-22_maleKumite>75', '18-22_maleKumiteTeam',
        '18-22_femaleKumite44', '18-22_femaleKumite48', '18-22_femaleKumite52', '18-22_femaleKumite56', '18-22_femaleKumite60', '18-22_femaleKumite>60', '18-22_femaleKumiteTeam'
    ];
    ...
    if (fileUpload.files.length > 0) {
        for (let i = 0; i < fileUpload.files.length; i++) {
            ...
            reader.onload = function(e) {
                ...
                if (!sheetName) {
                    alert('Không tìm thấy sheet cho lứa tuổi >18.');
                    return;
                }
...
function validateAge() {
    ...
    if (age < 18 || age > 22) {
        document.getElementById('ageError').textContent = 'Vận động viên phải từ 18 đến 22 tuổi.';
        return false;
    } else {
...
function exportExcel() {
    ...
    const filename = '18-22_athlete_data.xlsx';
    function s2ab(s) {
...
function getDataForExport() {
    ...
    athletes.forEach((athlete, index) => {
        ...
        data.push({
            ...
            'CLB': athlete.club,
            'Kata Nam(18-22)': athlete.categories.includes('18-22_maleKata') ? 'X' : '',
            'Kata Nữ(18-22)': athlete.categories.includes('18-22_femaleKata') ? 'X' : '',
            'Kata đồng đội nam(18-22)': athlete.categories.includes('18-22_ddnamKata') ? 'X' : '',
            'Kata đồng đội nữ(18-22)': athlete.categories.includes('18-22_ddnuKata') ? 'X' : '',
            'Kumite nam 50Kg(18-22)': athlete.categories.includes('18-22_maleKumite50') ? 'X' : '',
            'Kumite nam 55Kg(18-22)': athlete.categories.includes('18-22_maleKumite55') ? 'X' : '',
            'Kumite nam 60Kg(18-22)': athlete.categories.includes('18-22_maleKumite60') ? 'X' : '',
            'Kumite nam 65Kg(18-22)': athlete.categories.includes('18-22_maleKumite65') ? 'X' : '',
            'Kumite nam 70Kg(18-22)': athlete.categories.includes('18-22_maleKumite70') ? 'X' : '',
            'Kumite nam 75Kg(18-22)': athlete.categories.includes('18-22_maleKumite75') ? 'X' : '',
            'Kumite nam >75Kg(18-22)': athlete.categories.includes('18-22_maleKumite>75') ? 'X' : '',
            'Kumite đồng đội nam(18-22)': athlete.categories.includes('18-22_maleKumiteTeam') ? 'X' : '',
            'Kumite nữ 44Kg(18-22)': athlete.categories.includes('18-22_femaleKumite44') ? 'X' : '',
            'Kumite nữ 48Kg(18-22)': athlete.categories.includes('18-22_femaleKumite48') ? 'X' : '',
            'Kumite nữ 52Kg(18-22)': athlete.categories.includes('18-22_femaleKumite52') ? 'X' : '',
            'Kumite nữ 56Kg(18-22)': athlete.categories.includes('18-22_femaleKumite56') ? 'X' : '',
            'Kumite nữ 60Kg(18-22)': athlete.categories.includes('18-22_femaleKumite60') ? 'X' : '',
            'Kumite nữ >60Kg(18-22)': athlete.categories.includes('18-22_femaleKumite>60') ? 'X' : '',
            'Kumite đồng đội nữ(18-22)': athlete.categories.includes('18-22_femaleKumiteTeam') ? 'X' : ''
